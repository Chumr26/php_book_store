...
-- Tác giả Việt Nam (bổ sung)
INSERT INTO tacgia (ten_tacgia, but_danh, tieu_su, ngay_sinh, quoc_tich, hinh_anh) VALUES
('Nam Cao', NULL, 'Nhà văn hiện thực phê phán, nổi tiếng với các truyện ngắn và tiểu thuyết về số phận người nông dân.', '1915-10-29', 'Việt Nam', 'nam_cao.jpg'),
('Ngô Tất Tố', NULL, 'Nhà văn, nhà báo Việt Nam, được biết đến với tác phẩm phản ánh xã hội nông thôn.', '1893-12-31', 'Việt Nam', 'ngo_tat_to.jpg'),
('Tô Hoài', NULL, 'Nhà văn Việt Nam hiện đại, nổi bật với tác phẩm viết cho thiếu nhi.', '1920-09-27', 'Việt Nam', 'to_hoai.jpg'),
('Đoàn Giỏi', NULL, 'Nhà văn viết về miền Tây Nam Bộ với lối kể giàu chất sử thi và thiên nhiên.', '1925-05-17', 'Việt Nam', 'doan_gioi.jpg'),
('Kim Lân', NULL, 'Nhà văn chuyên viết truyện ngắn về nông thôn và người lao động nghèo.', '1920-08-01', 'Việt Nam', 'kim_lan.jpg'),
('Hồ Chí Minh', NULL, 'Lãnh tụ, nhà thơ, tác giả nhiều tác phẩm văn học và chính luận.', '1890-05-19', 'Việt Nam', 'ho_chi_minh.jpg'),
('Nguyễn Nhật Ánh', NULL, 'Nhà văn đương đại, nổi tiếng với tác phẩm viết về tuổi học trò.', '1955-05-07', 'Việt Nam', 'nguyen_nhat_anh.jpg'),
('Phùng Quán', NULL, 'Nhà văn, nhà thơ Việt Nam, nổi bật với tác phẩm về tuổi thơ và chiến tranh.', '1932-01-24', 'Việt Nam', 'phung_quan.jpg'),
('Vũ Trọng Phụng', NULL, 'Nhà văn hiện thực phê phán, nổi tiếng với các tác phẩm phản ánh xã hội đô thị và thân phận con người.', '1912-10-20', 'Việt Nam', 'vu_trong_phung.jpg'),
('Ngô Thừa Ân', NULL, 'Nhà văn cổ điển Á Đông, tác giả Tây Du Ký.', '1500-01-01', 'Trung Quốc', 'ngo_thua_an.jpg');
...
-- Nhà xuất bản Việt Nam (bổ sung)
INSERT INTO nhaxuatban (ten_nxb, dia_chi, dien_thoai, email, website) VALUES
('NXB Văn Học', '18 Nguyễn Trường Tộ, Ba Đình, Hà Nội', '+84-24-3733-0135', 'info@nxbvanhoc.vn', 'https://nxbvanhoc.vn'),
('NXB Kim Đồng', '55 Quang Trung, Hai Bà Trưng, Hà Nội', '+84-24-3943-6076', 'info@nxbkimdong.com.vn', 'https://nxbkimdong.com.vn'),
('NXB Trẻ', '161B Lý Chính Thắng, Q3, TP.HCM', '+84-28-3931-8900', 'info@nxbtre.com.vn', 'https://www.nxbtre.com.vn'),
('NXB Hội Nhà Văn', '65 Nguyễn Du, Hai Bà Trưng, Hà Nội', '+84-24-3822-5275', 'info@nxhnhavan.vn', 'https://nxhnhavan.vn'),
('NXB Chính Trị Quốc Gia Sự Thật', '6/86 Duy Tân, Cầu Giấy, Hà Nội', '+84-24-3792-7869', 'info@nxbctqg.vn', 'https://nxbctqg.vn');
...
-- Bổ sung 10 sách Việt Nam phổ biến
INSERT INTO sach (ten_sach, id_tacgia, id_nxb, id_theloai, isbn, gia, gia_goc, hinh_anh, mo_ta, so_trang, nam_xuat_ban, so_luong_ton, noi_bat) VALUES
('Lão Hạc', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Nam Cao'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Văn Học'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001001', 115000, 140000, 'lao_hac.jpg', 'Lão Hạc là câu chuyện về một người nông dân già sống lầm lũi trong cảnh nghèo và cô độc. Nhân vật chính giữ lại một con chó nhỏ như người thân cuối cùng, coi nó là kỷ vật của đứa con trai đã bỏ làng đi biệt. Trong ngôi làng nghèo ấy, danh dự và lòng tự trọng là thứ còn lại để bám víu, nhưng nó lại đòi hỏi cái giá quá đắt. Lão phải đắn đo giữa việc bán con chó để giữ mảnh vườn và sự ân hận dằn vặt về lòng thương. Mỗi lựa chọn đều khiến lão đau đớn, vừa thương con, vừa sợ bị xem là kẻ phản bội. Tác phẩm mô tả tỉ mỉ những bữa đói, những ngày mưa, và những cuộc trò chuyện nhỏ nhoi đầy nặng nề. Qua lời kể của người hàng xóm, bi kịch được bộc lộ dần, cho thấy người nghèo không chỉ thiếu ăn mà còn thiếu sự cảm thông. Lão Hạc không oán trách ai, chỉ âm thầm chịu đựng đến tận cùng. Kết thúc câu chuyện là một hành động khiến người đọc vừa xót xa vừa kính trọng. Tác phẩm đặt câu hỏi về phẩm giá, tình thương, và những điều con người sẵn sàng hy sinh để giữ gìn lòng tự trọng. Nó là lời nhắc rằng ngay trong nghèo khó, con người vẫn có thể sống tử tế và đứng thẳng, dù con đường đi tới điều ấy rất đau.', 176, 2019, 220, TRUE),
('Chí Phèo', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Nam Cao'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Văn Học'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001002', 120000, 150000, 'chi_pheo.jpg', 'Chí Phèo kể về một người nông dân bị đẩy ra khỏi đời sống lương thiện và trở thành kẻ lưu manh của làng Vũ Đại. Từ một anh canh điền hiền lành, Chí bị oan vào tù và trở về với thân phận bị mọi người ruồng bỏ. Anh tìm đến rượu, tiếng chửi, và những cuộc gây gổ như cách duy nhất để khẳng định mình còn tồn tại. Làng xã đối xử với Chí như một quái vật, chỉ biết sợ hãi và ghê tởm, không ai muốn nghe tiếng nói hay lời giải thích. Nhưng trong sâu thẳm, Chí vẫn thèm khát được sống tử tế, được có một mái nhà và một người thân. Cuộc gặp gỡ với Thị Nở mở ra một khoảnh khắc hy vọng mỏng manh, khi bát cháo hành gợi lại cảm giác được chăm sóc. Chí bắt đầu nghĩ đến việc làm lại, nhưng xã hội đã đóng cửa mọi con đường quay về. Bà cô Thị Nở nói lời độc địa khiến mọi hy vọng tan vỡ. Cơn tuyệt vọng đẩy Chí đến hành động bạo liệt cuối cùng. Tác phẩm khắc họa sự tàn nhẫn của cơ chế làng xã, nơi con người bị biến dạng bởi định kiến và bạo lực. Chí Phèo không chỉ là một bi kịch cá nhân, mà còn là lời tố cáo xã hội làm tha hóa con người. Câu chuyện khiến người đọc suy nghĩ về trách nhiệm cộng đồng và quyền được làm người của những số phận bị bỏ rơi. Đây là một tác phẩm vừa xót xa vừa dữ dội, đầy chất nhân đạo và sức ám ảnh lâu dài.', 160, 2020, 230, TRUE),
('Tắt Đèn', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Ngô Tất Tố'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Hội Nhà Văn'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001003', 125000, 155000, 'tat_den.jpg', 'Tắt Đèn xoay quanh cuộc đời chị Dậu, một người phụ nữ nông thôn bị cuốn vào vòng xoáy sưu thuế và bất công. Khi gia đình nghèo không đủ tiền nộp suất sưu cho chồng, chị phải chạy vạy khắp nơi để giữ cho người thân khỏi bị trói và đánh đập. Những hành động của chị vừa là bản năng sinh tồn, vừa là tình thương mãnh liệt dành cho chồng con. Trước mặt chị là quan lại hà khắc, tay sai tàn bạo, và cả một hệ thống coi người nghèo như món hàng có thể ép buộc. Cuốn sách mô tả chi tiết những ngày đói rách, tiếng khóc của trẻ con, và cảm giác tuyệt vọng khi không còn gì để cầm cố. Chị Dậu từng mềm mỏng van xin, từng nhẫn nhục chịu đựng, nhưng rồi cũng bị dồn đến giới hạn phải phản kháng. Hình ảnh chị đánh trả cai lệ vừa khiến người đọc cảm phục vừa khiến người đọc xót xa, bởi đó là phản kháng trong thế yếu. Tác phẩm đặt ra câu hỏi về công lý và sự phi nhân trong một xã hội nặng nề áp bức. Dù câu chuyện diễn ra ở nông thôn, nó gợi nhắc đến nhiều hoàn cảnh hiện đại, nơi người lao động vẫn bị đẩy đến bờ vực. Tắt Đèn vừa là bi kịch gia đình, vừa là bức tranh xã hội rộng lớn. Sự chân thực trong miêu tả cùng tinh thần nhân đạo đã khiến tác phẩm trở thành biểu tượng của văn học hiện thực Việt Nam. Đây là cuốn sách khiến người đọc day dứt về số phận và lòng trắc ẩn.', 208, 2018, 210, TRUE),
('Dế Mèn Phiêu Lưu Ký', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Tô Hoài'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Kim Đồng'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001004', 95000, 120000, 'de_men_phieu_luu_ky.jpg', 'Dế Mèn Phiêu Lưu Ký là hành trình trưởng thành của một chú dế trẻ đầy tự tin nhưng cũng nông nổi. Dế Mèn sống trong một hang đất rộng, thích phô trương sức mạnh và thường tỏ ra ngạo nghễ với những loài yếu hơn. Một lần trêu chọc và làm phiền, Dế Mèn vô tình gây ra bi kịch cho người bạn Dế Choắt hiền lành. Sự việc ấy trở thành cú sốc đầu đời, khiến Dế Mèn nhận ra trách nhiệm của mình và bắt đầu cuộc phiêu lưu để chuộc lỗi. Trên đường đi, chú gặp nhiều loài vật khác nhau, mỗi cuộc gặp là một bài học về lòng dũng cảm, sự khiêm nhường và tinh thần đoàn kết. Câu chuyện xen lẫn những đoạn tả thiên nhiên giàu màu sắc và cảm giác, làm thế giới côn trùng trở nên sống động như một xã hội thu nhỏ. Dế Mèn học cách lắng nghe, biết đặt mình vào vị trí người khác, và hiểu rằng sức mạnh thật sự phải đi kèm lòng nhân ái. Tác phẩm không chỉ dành cho thiếu nhi, mà còn là lời nhắc cho người lớn về những sai lầm của tuổi trẻ. Từ sự bốc đồng đến sự trưởng thành, hành trình của Dế Mèn phản chiếu sự phát triển của mỗi con người. Câu chuyện đem đến cảm hứng sống tích cực, khuyến khích vượt qua ích kỷ để hướng đến điều tốt đẹp hơn. Đây là cuốn sách giàu trí tưởng tượng, giàu tính giáo dục nhưng vẫn nhẹ nhàng, hài hước, dễ đọc và dễ nhớ.', 216, 2021, 300, TRUE),
('Đất Rừng Phương Nam', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Đoàn Giỏi'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Trẻ'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001005', 135000, 165000, 'dat_rung_phuong_nam.jpg', 'Đất Rừng Phương Nam kể về chuyến phiêu lưu của cậu bé An trên miền đất sông nước Nam Bộ trong thời kỳ kháng chiến. Mất gia đình giữa những biến động, An trôi dạt và gặp nhiều người tốt bụng giúp đỡ, từ chú Võ Tòng mạnh mẽ đến bác Ba Phi hào sảng. Những câu chuyện quanh An không chỉ là trải nghiệm sống còn mà còn là bài học về lòng yêu nước và tinh thần nghĩa hiệp. Tác phẩm mô tả thiên nhiên Nam Bộ với rừng tràm, sông rạch, muông thú phong phú và nhịp sống đậm chất miền Tây. Qua mỗi chặng đường, An hiểu thêm về tình người, về sự đoàn kết chống áp bức, và về một vùng đất rộng lớn giàu khí phách. Bằng lối kể giản dị, giàu hình ảnh, cuốn sách đưa người đọc vào thế giới vừa thơ mộng vừa khắc nghiệt. Những nhân vật trong truyện đại diện cho phẩm chất đẹp của người dân Nam Bộ: hào sảng, kiên cường, và giàu lòng trắc ẩn. Hành trình của An cũng là hành trình trưởng thành, từ một đứa trẻ hoang mang đến một người hiểu thế nào là trách nhiệm và lòng biết ơn. Tác phẩm mang chất sử thi nhẹ nhàng, thể hiện niềm tự hào về đất và người phương Nam. Đất Rừng Phương Nam vì thế vừa là cuốn truyện phiêu lưu hấp dẫn vừa là bức tranh văn hóa giàu sức sống. Nó giúp người đọc cảm nhận sâu sắc mối liên hệ giữa con người, thiên nhiên và lịch sử.', 320, 2017, 180, TRUE),
('Tây Du Ký', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Ngô Thừa Ân'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Văn Học'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001006', 220000, 260000, 'tay_du_ky.jpg', 'Tây Du Ký là câu chuyện huyền ảo về hành trình thỉnh kinh của Đường Tăng cùng ba đồ đệ. Mỗi nhân vật mang một tính cách riêng: Tôn Ngộ Không thông minh, nóng nảy; Trư Bát Giới tham ăn, lười biếng; Sa Tăng hiền lành, kiên nhẫn. Hành trình vượt qua 81 kiếp nạn là chuỗi thử thách về lòng tin, kỷ luật và sự tu dưỡng bản thân. Cuốn sách kết hợp yếu tố thần thoại, triết lý và tiếng cười, tạo nên một bức tranh vừa kỳ ảo vừa gần gũi. Các yêu quái, phép thuật, và những cuộc chiến gay cấn chỉ là lớp vỏ, bên trong là câu chuyện về sự trưởng thành và giải thoát. Tôn Ngộ Không từng là một kẻ ngỗ ngược, nhưng nhờ hành trình này mà biết kiềm chế và bảo vệ người khác. Trư Bát Giới cũng dần học cách vượt qua ham muốn và ích kỷ. Đường Tăng thể hiện sự kiên định, dù nhiều lần bị dao động bởi sợ hãi và cám dỗ. Tác phẩm khuyến khích người đọc suy nghĩ về con đường tu tâm, về sự kiên trì trước khó khăn, và về việc dung hòa cá tính để đạt mục tiêu chung. Tây Du Ký còn là kho tàng văn hóa với những điển tích, biểu tượng và bài học đạo đức. Dù xuất phát từ văn học cổ, câu chuyện vẫn hấp dẫn với người đọc hiện đại nhờ nhịp kể nhanh và trí tưởng tượng phong phú. Đây là tác phẩm phù hợp để đọc giải trí nhưng cũng để suy ngẫm về sức mạnh nội tâm.', 580, 2016, 150, TRUE),
('Vợ Nhặt', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Kim Lân'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Hội Nhà Văn'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001007', 98000, 125000, 'vo_nhat.jpg', 'Vợ Nhặt kể về một cuộc hôn nhân kỳ lạ xảy ra giữa nạn đói khốc liệt. Tràng, một người đàn ông nghèo, vô tình “nhặt” được vợ giữa chợ đói chỉ qua vài câu bông đùa. Câu chuyện mở ra bức tranh u ám của xã hội với những xác người bên đường, những tiếng kêu đói và những bóng người lầm lũi. Tuy vậy, giữa bi kịch ấy vẫn le lói những tia sáng của tình người. Tràng đưa người đàn bà xa lạ về nhà trong sự ngạc nhiên và lo sợ của mẹ già. Bữa cơm ngày đói chỉ có cháo loãng và rau dại, nhưng cả gia đình cố gắng giữ sự ấm áp và hy vọng. Người vợ mới đến bỗng trở nên hiền lành, chăm chỉ, làm căn nhà nghèo có thêm sinh khí. Mẹ Tràng dù lo lắng vẫn cố gắng mở lòng, mong tương lai tốt đẹp hơn cho con. Tác phẩm nhấn mạnh sức sống bền bỉ của con người trong hoàn cảnh khắc nghiệt nhất. Niềm hy vọng, dù nhỏ bé, vẫn đủ giúp họ bước tiếp. Vợ Nhặt không chỉ là câu chuyện về đói nghèo mà còn là lời khẳng định về khát vọng sống và khát vọng hạnh phúc. Hình ảnh đoàn người đi phá kho thóc ở cuối truyện gợi ra niềm tin vào sự đổi thay. Với giọng văn giản dị và giàu tình cảm, tác phẩm khiến người đọc vừa đau xót vừa tin tưởng. Đây là một truyện ngắn xuất sắc về lòng nhân ái và sức mạnh của sự sống.', 136, 2018, 210, TRUE),
('Nhật Ký Trong Tù', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Hồ Chí Minh'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Chính Trị Quốc Gia Sự Thật'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001008', 130000, 160000, 'nhat_ky_trong_tu.jpg', 'Nhật Ký Trong Tù là tập thơ được viết trong hoàn cảnh tù đày gian khổ, nhưng vẫn toát lên tinh thần lạc quan và ý chí vượt khó. Những bài thơ ngắn gọn, hàm súc, ghi lại đời sống trong nhà giam với những đêm lạnh, những bữa cơm đạm bạc và những cuộc chuyển lao mệt mỏi. Dù hoàn cảnh khắc nghiệt, tác giả không để mình chìm trong u tối. Trái lại, thơ mở ra một thế giới nội tâm kiên cường, tin vào ánh sáng và tương lai. Tập thơ thể hiện sự rung cảm trước thiên nhiên, từ ánh trăng, tiếng gà đến sắc núi, như những khoảng nghỉ tinh thần giữa sự tù túng. Nhiều bài thơ còn bộc lộ lòng thương người, sự cảm thông với những bạn tù khổ cực. Tác phẩm không chỉ là nhật ký tinh thần mà còn là bài học về nghị lực. Người đọc thấy rõ ý chí tự rèn luyện, luôn hướng về mục tiêu lớn, không bị nhấn chìm bởi hoàn cảnh. Ngôn ngữ giản dị nhưng giàu hình ảnh, gợi cảm giác vừa bình tĩnh vừa xúc động. Nhật Ký Trong Tù là minh chứng cho sức mạnh của tinh thần, cho khả năng biến đau khổ thành năng lượng sáng tạo. Nó cũng là một di sản văn hóa, kết nối giữa thơ ca và lịch sử. Tập thơ giúp người đọc nhận ra rằng tự do không chỉ là không gian, mà còn là trạng thái bên trong. Dù bị giam cầm, con người vẫn có thể giữ vững phẩm giá và niềm tin.', 200, 2015, 190, TRUE),
('Mắt Biếc', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Nguyễn Nhật Ánh'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Trẻ'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001009', 145000, 175000, 'mat_biec.jpg', 'Mắt Biếc là câu chuyện tình tuổi học trò trong trẻo nhưng day dứt giữa Ngạn và Hà Lan. Cả hai lớn lên ở một làng quê yên bình, nơi những hàng cây, con đường và ánh trăng trở thành ký ức không phai. Ngạn yêu đôi mắt biếc của Hà Lan từ khi còn nhỏ, tình cảm ấy theo anh suốt những năm tháng trưởng thành. Khi Hà Lan lên thành phố, cuộc sống mới mang lại những lựa chọn khác và những cám dỗ xa lạ. Ngạn vẫn kiên trì ở bên, nhưng khoảng cách giữa hai người ngày càng lớn. Câu chuyện khắc họa nỗi đau của tình yêu đơn phương, khi người ở lại luôn nhớ về một hình ảnh đẹp nhưng không thể chạm tới. Dù vậy, tác phẩm không chỉ là nỗi buồn, mà còn là sự trân trọng những cảm xúc đầu đời. Những kỷ niệm tuổi thơ, những buổi học, những tiếng cười và cả những giọt nước mắt được kể lại bằng giọng văn nhẹ nhàng. Mắt Biếc cho thấy sự trưởng thành không chỉ là rời khỏi quê hương mà còn là học cách chấp nhận và tha thứ. Ngạn hiểu rằng tình yêu không thể ép buộc và đôi khi yêu là để người kia được sống đúng với lựa chọn của mình. Câu chuyện cũng đặt ra câu hỏi về sự khác biệt giữa mơ mộng và hiện thực. Với bối cảnh làng quê Việt Nam đầy thơ mộng, tác phẩm gợi cảm giác gần gũi và ấm áp. Đây là cuốn sách khiến người đọc bùi ngùi về tuổi trẻ, về những điều đẹp đẽ đã qua và những điều không thể giữ lại.', 260, 2019, 240, TRUE),
('Tuổi Thơ Dữ Dội', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Phùng Quán'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Kim Đồng'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001010', 165000, 200000, 'tuoi_tho_du_doi.jpg', 'Tuổi Thơ Dữ Dội kể về những thiếu niên tham gia kháng chiến trong bối cảnh đầy nguy hiểm nhưng cũng chan chứa lý tưởng. Các nhân vật chính là những cậu bé, cô bé với mơ ước giản dị, nhưng lại sớm đối mặt với bom đạn và mất mát. Họ mang trong mình lòng yêu nước và tinh thần trách nhiệm vượt quá tuổi đời. Tác phẩm mô tả hành trình làm liên lạc, trinh sát, chuyển thư, đối mặt với hiểm nguy mỗi ngày. Dù sống trong khói lửa, các em vẫn giữ được sự hồn nhiên, sự chân thành và tình bạn trong sáng. Những đoạn miêu tả tuổi thơ vừa ngọt ngào vừa dữ dội, tạo nên cảm xúc mạnh mẽ cho người đọc. Câu chuyện làm nổi bật sự hy sinh thầm lặng của những người trẻ tuổi, những người mà cuộc đời đáng ra nên là những ngày đến trường yên bình. Bên cạnh các cảnh hành động, tác phẩm còn dành nhiều trang cho suy nghĩ nội tâm, sự sợ hãi, và lòng dũng cảm khi vượt qua nỗi sợ. Những mất mát được kể với giọng văn mộc mạc, khiến sự đau đớn trở nên chân thực. Tuổi Thơ Dữ Dội không tô hồng chiến tranh, mà cho thấy cái giá của tự do và hòa bình. Đồng thời, tác phẩm cũng tôn vinh tình bạn, tình đồng đội và khát vọng sống. Đây là cuốn sách giúp người đọc hiểu hơn về lịch sử qua lăng kính của tuổi thơ. Nó để lại ấn tượng sâu sắc về lòng can đảm và sự trưởng thành trong nghịch cảnh.', 420, 2017, 180, TRUE),
('Làm đĩ', (SELECT id_tacgia FROM tacgia WHERE ten_tacgia = 'Vũ Trọng Phụng'), (SELECT id_nxb FROM nhaxuatban WHERE ten_nxb = 'NXB Văn Học'), (SELECT id_theloai FROM theloai WHERE ten_theloai = 'Văn học Việt Nam'), '9786040001011', 135000, 165000, 'lam_di.jpg', 'Làm đĩ là một tác phẩm hiện thực phê phán nhìn thẳng vào những định kiến và bất công trong xã hội đô thị. Câu chuyện được kể qua lời tự thuật của một người phụ nữ trẻ, từ tuổi thơ trong gia đình nghèo đến những lựa chọn sai lầm dẫn tới bi kịch. Không tập trung vào mô tả dung tục, cuốn sách chú ý vào bối cảnh giáo dục, quan niệm đạo đức và sức ép xã hội đã đẩy một con người vào đường cùng. Tác phẩm đặt câu hỏi về trách nhiệm của gia đình, nhà trường và cộng đồng khi họ lên án một cá nhân nhưng lại né tránh việc nhìn vào cơ chế tạo ra bi kịch. Nhân vật chính trải qua nhiều cú sốc, vừa đấu tranh để giữ nhân phẩm, vừa bị cuốn vào vòng xoáy của nghèo đói, kỳ thị và cô đơn. Sự đứt gãy giữa những lời khuyên đạo đức và đời sống thực tế khiến cô mất đi chỗ dựa, từ đó đánh mất niềm tin vào bản thân. Văn phong sắc lạnh nhưng giàu cảm thông, tác giả cho thấy con người không phải sinh ra đã sai trái, mà bị định hình bởi môi trường và sự thiếu hiểu biết. Cuốn sách cũng phản ánh xã hội thời đó với những mặt tối: giả dối, đạo đức hình thức và quyền lực đè nén. Tuy nặng nề, tác phẩm vẫn chứa đựng niềm mong mỏi về sự cảm thông và thay đổi. Đây là một lời cảnh tỉnh về việc giáo dục giới tính, lòng trắc ẩn và thái độ đối với những người bị gạt ra bên lề. Tác phẩm giúp người đọc nhìn rõ hơn nguyên nhân của bi kịch và thấu hiểu số phận con người trong bối cảnh lịch sử đầy biến động.', 240, 2019, 170, TRUE);
